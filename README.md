...
React Native/Expo technical test project replicating the "khoảnh khắc đáng nhớ" section from the ZIM homepage.
...
_(Requires Java/Android SDK installed locally. Drop the `--local` flag to build on Expo's cloud if you have an EAS account)._
